...
/**
 * Grid Class. This class defines a grid as an <i> ArrayList </i> of Objects and
 * an <i> HashMap </i> of cells {@link Cell}.
 *
 * @author IAThinkers
 */
public class Grid extends Parent {
    ...
    /**
     * ArrayList variable used to store all the objects (Wall, Door, Points,...)
     * that had been put on the grid
     */
    ...
    /**
     * HashMap variable storing every cell of the grid using a key following
     * this syntax : '#i-j' where i is the column of the cell and j its row.
     */
    ...
    /**
     * Used to access the language variable in an easier way throughout the
     * methods of this class
     */
    private ResourceBundle messages;

    /**
     * Constructor of a grid : initiates every cell of the grid, giving it its
     * <i> hover </i> and <i> onClick </i> properties
     *
    ...
    /**
     * Change the state of a door : pass it from being close to being open and
     * vice versa
     *
     * @param height
     * @param width
