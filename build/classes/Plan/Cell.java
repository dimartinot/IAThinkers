...
public class Cell extends StackPane {
     ...
     * @param x X position of the cell, in integer (i.e. the column in which the
     * cell is put)
     * @param y Y position of the cell, in integer (i.e the row in which the
     * cell is put)
    ...
    /**
     * <i> Hover </i> method for the cells. Its main purposes are to change the
     * filling color of the rectangle object of the hovered cell + it displays
     * its position in a <i>Text</i> object, on the VBbox at the right side.
     *
     * @param scene Scene variable of the {@link Plan} class, used to lookup for
     * the the <i> Text </i> object, using its id.
     */
    ...
    /**
     * Method deactivating the <i> hover </i> effect when the mouse leaves the
     * cell.
     *
    ...
    /**
     * Method used to change the color of the hovered cell. It is important to
     * notice that the coloring depends on many things : it will happen only if
     * the object the user is intending to put down fits. If it does not, then
     * there is no need to change the color the cell. Furthermore, in the case
     * of a wall, the coloration will actually take the shape of the expected
     * wall.
     *
     * @param scene Scene variable useful to check which object is intended to
     * be put
